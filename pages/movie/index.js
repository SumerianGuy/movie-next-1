...
import MoviePlayer from 'components/MovieSummary/MovieInfo/TheMoviePlayer/Movie';
...
const Movie = () => {
  ...
  if (blockedTmdbIds.includes(movie?.id?.toString())) {
    return (
  ...
  return (
    <PageWrapper>
      ...
      <MoviePlayer videoUrl={movie.id} />
      <MovieSummary baseUrl={baseUrl} movie={movie} />
      <RecommendedMovieList baseUrl={baseUrl} recommendedMovies={recommendedMovies} />
    </PageWrapper>
  );
};
