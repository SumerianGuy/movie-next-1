...
const TheSelectSearch = React.forwardRef(({ id, name, label, classes, ...rest }, ref) => (
  <>
    <FormControl>
      ...
      <SelectSearch
        ...
        renderValue={(valueProps) => (
          <input id={id} name={name} className={clsx(defaultClasses?.["input"], classes?.["input"])} {...valueProps} />
        )}
        {...rest}
      />
    </FormControl>
