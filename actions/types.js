...
// TV-related action types
const FETCH_TVSHOW = 'FETCH_TVSHOW';
const FETCH_GENRE_TVSHOWS = 'FETCH_GENRE_TVSHOWS';
const FETCH_STATIC_CATEGORY_TVSHOWS = 'FETCH_STATIC_CATEGORY_TVSHOWS';
const FETCH_SEARCH_TVSHOWS = 'FETCH_SEARCH_TVSHOWS';
const FETCH_RECOMMENDED_TVSHOWS = 'FETCH_RECOMMENDED_TVSHOWS';
const FETCH_PERSON_TVSHOWS = 'FETCH_PERSON_TVSHOWS';
const FETCH_EPISODES = 'FETCH_EPISODES';
const SET_EPISODES = 'SET_EPISODES'; // New action type to set episodes
const CLEAR_EPISODES = 'CLEAR_EPISODES'; // New action type to clear episodes
...
// Loading tv
const SET_TVSHOW_LOADING = 'SET_TVSHOW_LOADING';
const UNSET_TVSHOW_LOADING = 'UNSET_TVSHOW_LOADING';

const SET_EPISODES_LOADING = 'SET_EPISODES_LOADING';
const UNSET_EPISODES_LOADING = 'SET_EPISODES_LOADING';
...
export {
  ...
  SET_EPISODES, // New action type to set episodes
  CLEAR_EPISODES, // New action type to clear episodes
  FETCH_GENRE_TVSHOWS,
  FETCH_STATIC_CATEGORY_TVSHOWS,
  FETCH_SEARCH_TVSHOWS,
  FETCH_RECOMMENDED_TVSHOWS,
  FETCH_PERSON_TVSHOWS,
  FETCH_CREDITS,
  FETCH_GENRE_MOVIES,
  ...
  FETCH_PERSON_MOVIES,
  SET_TVSHOW_LOADING,
  UNSET_TVSHOW_LOADING,
  UNSET_EPISODES_LOADING,
  SET_LOADING,
  UNSET_LOADING,
  SET_MOVIES_LOADING,
